...
export const SQUARE_BUBBLE_PROBABILITY = 0;
// export const GOLD_BUBBLE_PROBABILITY = 0.01;
export const GOLD_BUBBLE_PROBABILITY = 0;
// export const BLACKHOLE_BUBBLE_PROBABILITY = 0.001;
export const BLACKHOLE_BUBBLE_PROBABILITY = 0;
// export const VIRUS_BUBBLE_PROBABILITY = 0.005;
export const VIRUS_BUBBLE_PROBABILITY = 0;
// export const ANTIVIRUS_BUBBLE_PROBABILITY = 0.005;
export const ANTIVIRUS_BUBBLE_PROBABILITY = 0;
